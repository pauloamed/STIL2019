...
charBILSTM = char_model.CharBILSTM(CHAR_EMBEDDING_DIM, WORD_EMBEDDING_DIM, char2id, device)
wordBILSTM1 = word_model.WordBILSTM(WORD_EMBEDDING_DIM, device)
wordBILSTM2 = word_model.WordBILSTM(WORD_EMBEDDING_DIM, device)
